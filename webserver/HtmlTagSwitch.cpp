...
namespace webserver
{
	HtmlTagSwitch::HtmlTagSwitch(const datamodel::Switch* mySwitch)
	{
		...
		unsigned int layoutPosX = mySwitch->posX * 35;
		unsigned int layoutPosY = mySwitch->posY * 35;
		...
		{
			image = "<svg width=\"35\" height=\"35\" id=\"" + id + "_img\" style=\"transform:rotate(" + datamodel::LayoutItem::Rotation(mySwitch->rotation) + "deg);\"><polygon points=\"13,26 22,35 13,35\" fill=\"black\" /><polygon points=\"0,13 13,26 13,35 0,22\" fill=\"gray\" class=\"turnout\"/><polygon points=\"13,0 22,0 22,35 13,26\" fill=\"gray\" class=\"straight\"/></svg>";
		}
		else
		{
			image = "<svg width=\"35\" height=\"35\" id=\"" + id + "_img\" style=\"transform:rotate(" + datamodel::LayoutItem::Rotation(mySwitch->rotation) + "deg);\"><polygon points=\"22,26 22,35 13,35\" fill=\"black\" /><polygon points=\"22,26 35,13 35,22 22,35\" fill=\"gray\" class=\"turnout\"/><polygon points=\"13,0 22,0 22,26 13,35\" fill=\"gray\" class=\"straight\"/></svg>";
		}
