...
namespace Hardware
{
	...
	void ProtocolMaerklinCAN::ParseCs2FileLocomotiveFunction(deque<string>& lines, LocoCacheEntry& cacheEntry)
	{
		...
		while (lines.size())
		{
			...
			else if (key.compare("typ") == 0)
			{
				...
				type = static_cast<LocoFunctionType>((valueInt >> 7) + 1); // CS2: 1 = permanent, 2 = once
			}
	...
	const LocoFunctionIcon ProtocolMaerklinCAN::LocoFunctionMapCs2ToRailControl[MaxNrOfCs2FunctionIcons] = {
		LocoFunctionIconNone,
		LocoFunctionIconLight,
	...
	const ProtocolMaerklinCAN::LocoFunctionCs2Icon ProtocolMaerklinCAN::LocoFunctionMapRailControlToCs2[MaxLocoFunctionIcons] = {
