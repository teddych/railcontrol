...
/* TextCs2MasterLocoFunctionType */ { "CS2 Master has locomotive with function {0} of type {1}", "CS2 Master hat eine Lokomotive mit Funktion {0} mit Typ {1}", "CS2 master tiene una locomotora con la función {0} con el typo {1}" },
