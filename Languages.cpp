...
/* TextDifferentPushpullTypes */ { "Loco and street {0} have different push-pull types", "Lok und Fahrstrasse {0} haben verschiedene Wendezugeinstellungen", "Tren e itinerario tienen ajustes de push-pull differentes" },
