...
/* TextTrackStatusIsOccupied */ { "Track {0} is occupied by {1}", "Gleis {0} ist besetzt von {1}", "Vía {0} está ocupada por {1}" },
/* TextTrackStatusIsReserved */ { "Track {0} is reserved by {1}", "Gleis {0} ist reserviert von {1}", "Vía {0} está reservada por {1}" },
