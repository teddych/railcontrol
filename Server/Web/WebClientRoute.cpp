...
namespace Server { namespace Web
{
		...
		const FeedbackID feedbackIdOver) const
	{
		...
		tag.AddChildTag(HtmlTagInputDelay("reduceddelay", reducedDelay, 0, 600));
		...
		tag.AddChildTag(HtmlTagInputDelay("creepdelay", creepDelay, 0, 600));
		...
		tag.AddChildTag(HtmlTagInputDelay("stopdelay", stopDelay, 0, 600));
