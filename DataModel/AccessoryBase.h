...
namespace DataModel
{
	...
	enum AccessoryState : unsigned char
	{
		...
		SignalStateExpectedStop     = SignalStateStop + 0x20,
		SignalStateExpectedClear,
		SignalStateExpectedAspect2,
		SignalStateExpectedAspect3,
		SignalStateExpectedAspect4,
		SignalStateExpectedAspect5,
		SignalStateExpectedAspect6,
		SignalStateExpectedAspect7,
		SignalStateExpectedAspect8,
		SignalStateExpectedAspect9,
		SignalStateExpectedAspect10,
		SignalStateMax              = SignalStateExpectedAspect10,
